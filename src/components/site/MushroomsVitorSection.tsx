...
import { mushroomsVitorSection } from "@/content/site";

export function MushroomsVitorSection() {
  return (
    <section className="grid w-full grid-cols-1 md:grid-cols-2">
      <div className="relative min-h-[min(28rem,78vw)] md:min-h-[34rem]">
        <Image
          src={mushroomsVitorSection.image}
          alt={mushroomsVitorSection.imageAlt}
          fill
