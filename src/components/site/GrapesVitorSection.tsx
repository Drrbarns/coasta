...
import { grapesVitorSection } from "@/content/site";

export function GrapesVitorSection() {
  return (
    <section className="grid w-full grid-cols-1 md:grid-cols-2">
      <div className="relative min-h-[min(28rem,78vw)] md:min-h-[34rem]">
        <Image
          src={grapesVitorSection.image}
          alt={grapesVitorSection.imageAlt}
          fill
