...
import { mushroomsHydroponicSection } from "@/content/site";

export function MushroomsHydroponicSection() {
  return (
    <section className="relative grid w-full grid-cols-1 md:grid-cols-2">
      <div className="relative min-h-[min(28rem,78vw)] md:min-h-[34rem]">
        <Image
          src={mushroomsHydroponicSection.image}
          alt={mushroomsHydroponicSection.imageAlt}
          fill
