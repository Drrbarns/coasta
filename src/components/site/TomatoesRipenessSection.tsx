...
import { tomatoesRipenessSection } from "@/content/site";

export function TomatoesRipenessSection() {
  return (
    <section className="relative grid w-full grid-cols-1 md:grid-cols-2">
      ...
      <div className="relative min-h-[min(28rem,78vw)] md:min-h-[34rem]">
        <Image
          src={tomatoesRipenessSection.image}
          alt={tomatoesRipenessSection.imageAlt}
          fill
