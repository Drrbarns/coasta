...
import { avocadoJourneySection } from "@/content/site";

export function AvocadoJourneySection() {
  return (
    <section className="w-full bg-[var(--header-bg)]">
      ...
      <div className="grid w-full grid-cols-1 md:grid-cols-2">
        ...
        <div className="relative min-h-[min(28rem,78vw)] md:min-h-[34rem]">
          <Image
            src={avocadoJourneySection.image}
            alt={avocadoJourneySection.imageAlt}
            fill
