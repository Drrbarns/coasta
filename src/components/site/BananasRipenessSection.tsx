...
import { bananasRipenessSection } from "@/content/site";

export function BananasRipenessSection() {
  return (
    <section className="relative grid w-full grid-cols-1 md:grid-cols-2">
      ...
      <div className="relative min-h-[min(28rem,78vw)] md:min-h-[34rem]">
        <Image
          src={bananasRipenessSection.image}
          alt={bananasRipenessSection.imageAlt}
          fill
