...
import { bananasVitorSection } from "@/content/site";

export function BananasVitorSection() {
  return (
    <section className="grid w-full grid-cols-1 md:grid-cols-2">
      <div className="relative min-h-[min(28rem,78vw)] md:min-h-[34rem]">
        <Image
          src={bananasVitorSection.image}
          alt={bananasVitorSection.imageAlt}
          fill
